      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
         ...
         @csrf
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <input name="phone" id="phone" type="number" class="form-control" placeholder="Your Phone Number" required>
              </div>
            </div>
          </div>
...
<div class="google-map ">
	<div id="map" data-latitude="40.712776" data-longitude="-74.005974" data-marker="{{asset('frontend/images/marker.png')}}"></div>
</div>
